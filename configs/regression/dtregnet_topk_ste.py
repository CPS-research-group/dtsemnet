...
config_abalone = {
    ...
    "smax_temp": 1, # temperature for softmax, not used in hard argmax
...
config_ailerons = {
    ...
    "wt_init": 'none', # xavier normal weight init ['ortho, 'xavier_uniform', 'xavier_norm', 'none']
    "smax_temp": 0.5, # temperature for softmax, not used in hard argmax
    ...
    # with detach 64, 0.05 and 0.9 for top8 and top4 did well
    # without detach, getting sparse leaves 64, 0.06 for top8
    # "epochs": 80,
    # "batch_size": 64,
    # "learning_rate": 0.04,
    # "lr_scheduler": True,
