...
MY_POSSIBLES = [
    EXPANDED_TYPES.COMMAND_CENTER, EXPANDED_TYPES.SUPPLY_DEPOT,
    EXPANDED_TYPES.REFINERY, EXPANDED_TYPES.BARRACKS,
    EXPANDED_TYPES.ENGINEERING_BAY, EXPANDED_TYPES.ARMORY,
    EXPANDED_TYPES.FACTORY, EXPANDED_TYPES.STARPORT, EXPANDED_TYPES.SCV,
    EXPANDED_TYPES.MARINE, EXPANDED_TYPES.HELLION
]
